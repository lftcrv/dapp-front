...
const NextDistribution = memo(({ timeLeft, userShare, address }: NextDistributionProps) => (
...
const DistributionInfo = memo(({ feesData, userSharePercentage }: DistributionInfoProps) => (
...
const ClaimButton = memo(({ address, userShare, isClaiming, onClaim }: ClaimButtonProps) => (
  <Button
    className={cn(
...
const DistributionCard = memo(({ address, feesData, userSharePercentage }: DistributionCardProps) => (
