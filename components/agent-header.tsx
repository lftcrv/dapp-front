...
const AgentAvatar = memo(({ agent, isLeftCurve, priceChange }: { agent: Agent, isLeftCurve: boolean, priceChange: number }) => {
...
const AgentInfo = memo(({ agent, isLeftCurve, gradientClass }: { agent: Agent, isLeftCurve: boolean, gradientClass: string }) => (
...
export const AgentHeader = memo(({ agent, isLoading, error }: AgentHeaderProps) => {
  if (isLoading) {
    return <LoadingState />
  }
