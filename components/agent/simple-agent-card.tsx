...
export default function SimpleAgentCard({ agent, created, by }: SimpleAgentCardProps) {
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between w-full">
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                <Badge variant="outline" className="text-green-300 bg-green-500/10 border-green-500/30 text-xs rounded-full px-2 py-0.5 h-5">
                  Active
                </Badge>
                <Badge variant="outline" className="text-orange-300 bg-orange-500/10 border-orange-500/30 text-xs rounded-full px-2 py-0.5 h-5">
                  Parent
                </Badge>
              </div>
            </div>
