  ...
  return (
    <div className={cn(loadingVariants({ variant, size }), className)}>
      ...
      <div className={cn(
        ...
        variant === 'leftcurve' ? 'border-violet-500/50' : 
        variant === 'rightcurve' ? 'border-yellow-500/50' : 
        'border-primary/50'
      )} />
      ...
      <div className={cn(
        ...
        variant === 'leftcurve' ? 'bg-violet-500/20' : 
        variant === 'rightcurve' ? 'bg-yellow-500/20' : 
        'bg-primary/20'
      )} />
