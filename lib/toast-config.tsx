...
const createToastContent = (title: string, description: string): React.ReactNode => {
  return React.createElement(
    'div',
    { className: 'flex flex-col gap-1' },
    React.createElement('span', { className: 'font-bold tracking-tight' }, title),
    React.createElement('span', { className: 'text-xs opacity-90 font-mono' }, description)
  )
}
