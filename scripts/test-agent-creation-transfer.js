// Script to test the agent creation transfer flow
...
async function main() {
  try {
    console.log('🔄 Starting agent creation transfer test...');
    ...
    try {
      ...
      if (result && result.length >= 2) {
        ...
        // In a real scenario, this transaction hash would be passed to the createAgent function
        console.log('🔄 In the actual flow, this transaction hash would be used to create the agent:');
        console.log(`- Transaction Hash: ${transaction_hash}`);
        console.log('- Creator Wallet: ', TEST_ACCOUNT_ADDRESS);
        console.log('- Curve Side: LEFT or RIGHT');
